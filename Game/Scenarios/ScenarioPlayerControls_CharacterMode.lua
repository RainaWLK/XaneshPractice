do
	...
	XANESHPRACTICE.ScenarioPlayerControls_CharacterMode = XANESHPRACTICE.inheritsFrom(super)
	local class=XANESHPRACTICE.ScenarioPlayerControls_CharacterMode

	
	function class:CreateAssociatedObjects()	
		-- -- dubious
		-- local selection=XANESHPRACTICE.Selection_ClickOnly.new()
