do
	XANESHPRACTICE.DEFAULTSCENARIO.Layout={}
	local layout=XANESHPRACTICE.DEFAULTSCENARIO.Layout
	layout.scale=20.5
	...
	function layout.ObeliskSmall(scenario,x,y)
		x,y=-y,-x
		local obj
		obj=XANESHPRACTICE.DEFAULTSCENARIO.ObeliskSmall.new()
	...
	function layout.ObeliskLarge(scenario,x,y)
		x,y=-y,-x
		local obj
		obj=XANESHPRACTICE.DEFAULTSCENARIO.ObeliskLarge.new()
		obj:Setup(scenario.game.environment_gameplay);tinsert(scenario.obelisks,obj)
		obj.position.x=(x-layout.center.x)*layout.scale
		obj.position.y=(y-layout.center.y)*layout.scale
	end
	...
	function XANESHPRACTICE.DEFAULTSCENARIO.Layout.SetObelisks(scenario,layoutindex)
