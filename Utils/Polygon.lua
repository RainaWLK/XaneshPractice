do
	...
	local TrianglePath = "Interface\\AddOns\\XaneshPractice\\Assets\\Graphics\\Misc\\triangle.tga"

	--- Draw a triangle texture with vertices at relative coords.  (0,0) is top-left, (1,1) is bottom-right.
	function XANESHPRACTICE.TAXIFRAME_TextureAdd ( frame, Layer, R, G, B, Ax, Ay, Bx, By, Cx, Cy )
	...
	-- print("Frame clamp:",frame:IsClampedToScreen())
		...
		Texture:Show()
		--								  --  R G B A R G B A
		--Texture:SetGradientAlpha("HORIZONTAL",1,1,1,0.5,1,1,1,0.5);
