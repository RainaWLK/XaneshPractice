...
function XANESHPRACTICE.inheritsFrom(baseClass)
	local new_class={}
	...
	if baseClass~=nil then
		...
		--print("WARNING: XANESHPRACTICE.inheritsFrom was given nil as its base class.  (we can't tell which class should be the parent from here)")
