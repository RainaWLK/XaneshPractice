...
function XANESHPRACTICE.MergeTables(first_table,second_table)
...
function XANESHPRACTICE.RemoveDuplicates(inputtable)
	local hash = {}
	local result = {}
...
function XANESHPRACTICE.tremovebyval(tab, val)
...
function XANESHPRACTICE.tcontains(tab,val)
    for k,v in pairs(tab) do
     if(v==val) then
       return true
     end
